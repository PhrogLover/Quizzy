    ...
    return ( 
        <div id="layout" className="host-lobby">
            ...
            <div className="slide-script">
                <SlideScript setSaveLeaderboard = {props.setSaveLeaderboard} showLeaderboard = { props.showLeaderboard } setShowLeaderboard = { props.setShowLeaderboard } user = { props.user } teamList = { props.teamList } socket = {props.socket} mainId={props.mainId} quiz = { props.quiz } slideData={slideData} onSlideChange={setSlideData} onSlideChangeVar={slideData}/>
            </div>
